...
Model Training Notebook: [text](link)
Model Inference Notebook: [text](link)
Final Model on HuggingFace: [text](link)
...
In the end, I defaulted to pose estimation, as a way of working with significantly smaller data that was still informative to our task. 
...
* Validation accuracy is capped at 60% because the mean is well represented in the data, so it gets a fair few videos correct by accident.
